...
const SignUp = () => {
    ...
    return (
        <div>
            <div className="bg-slate-50 flex items-center min-h-screen p-4">
                <div className="w-full max-w-4xl md:max-w-3xl mx-auto px-4">
                    <div className="bg-white grid md:grid-cols-2 gap-10 w-full sm:p-8 p-6 shadow-md rounded-md overflow-hidden">
                        <div className="order-2 md:order-1 space-y-6">
                            ...
                            <div className="space-y-4">
                                <button type="button" className="px-4 py-2.5 flex items-center justify-center cursor-pointer rounded-md text-white text-sm font-medium tracking-wider border-none outline-none bg-blue-600 hover:bg-blue-700">
                                ...
                                <button type="button" className="px-4 py-2.5 flex items-center justify-center cursor-pointer rounded-md text-slate-900 text-sm font-medium tracking-wider border-none outline-none bg-slate-100 hover:bg-slate-200">
                                ...
                                <button type="button" className="px-4 py-2.5 flex items-center justify-center cursor-pointer rounded-md text-white text-sm font-medium tracking-wider border-none outline-none bg-black hover:bg-[#222]">
                        ...
                        <form className="w-full order-1 md:order-2">
                            <div className="mb-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="name" type="text" required className="bg-white border border-slate-300 w-full text-sm text-slate-900 pl-4 pr-10 py-2.5 rounded-md outline-blue-500" placeholder="Enter name" />
                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="email" type="email" required className="bg-white border border-slate-300 w-full text-sm text-slate-900 pl-4 pr-10 py-2.5 rounded-md outline-blue-500" placeholder="Enter email" />
                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="password" type="password" required className="bg-white border border-slate-300 w-full text-sm text-slate-900 pl-4 pr-10 py-2.5 rounded-md outline-blue-500" placeholder="Enter password" />
                            ...
                            <div className="!mt-8">
                                <button type="button" className="w-full py-2.5 px-4 text-sm font-medium tracking-wider cursor-pointer rounded-md bg-blue-600 hover:bg-blue-700 text-white focus:outline-none">
                                    Create Account
                                </button>
                            </div>
                            <p className="text-slate-600 text-sm mt-4 text-left">Already have an account? <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1">Login here</a></p>
                        </form>
                    </div>
                </div>
            </div>
